...
const FOCUS_OVERRIDES = {
  ...
  hawkeye: { x: 0.5, artLeft: 0, artRight: 1, artTop: 0, artBottom: 1 },
  falcon: { x: 0.5, artLeft: 0.18, artRight: 0.7, artTop: 0, artBottom: 0.389 },
  "spider-man-miles": { x: 0.5, artLeft: 0.42, artRight: 0.9, artTop: 0.13, artBottom: 0.555 },
  "ant-man": { x: 0.5, artLeft: 0.26, artRight: 0.74, artTop: 0.135, artBottom: 0.56 },
  wasp: { x: 0.5, artLeft: 0.3, artRight: 0.767, artTop: 0.12, artBottom: 0.538 },
  "spider-woman": { x: 0.5, artLeft: 0.28, artRight: 0.76, artTop: 0.13, artBottom: 0.554 },
  ...
  taskmaster: { x: 0.5, artLeft: 0.24, artRight: 0.76, artTop: 0.122, artBottom: 0.428 },
  unus: { x: 0.5, artLeft: 0.3, artRight: 0.65, artTop: 0.22, artBottom: 0.52 },
  "black-widow-yelena": { x: 0.5, artLeft: 0, artRight: 1, artTop: 0, artBottom: 1 },
  batroc: { x: 0.5, artLeft: 0, artRight: 1, artTop: 0, artBottom: 1 },
