...
assert(index.includes('styles.css?v=20260804-oxblood') && index.includes('app.js?v=20260804-oxblood'), "Versioned assets are missing; clients may receive stale layout files.");
